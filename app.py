...
# ----------------------------------------------------------------------
# Generování PDF protokolu (stálé tlačítko v hlavní ploše)
# ----------------------------------------------------------------------
st.divider()
...
# Vytvoření PDF dat do paměti při každém vykreslení stránky
...
# Stálé tlačítko ke stažení (viditelné hned pod grafy)
st.download_button(
