...
# ----------------------------------------------------------------------
# Generování PDF protokolu (přímo v hlavní ploše pod grafy)
# ----------------------------------------------------------------------
st.divider()
...
if st.button("📥 Vygenerovat a připravit PDF k stažení", type="primary"):
    import tempfile
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        st.download_button(
            label="✅ Kliknutím stáhnete vygenerované PDF",
            data=pdf_data,
